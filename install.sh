...
APP="$APPNAME sxhkd sxiv zathura firefox notify-send iwconfig catfish xfce4-terminal xfce4-power-manager volumeicon xscreensaver conky tint2 xbindkeys "
PERL=""
PYTH=""
PIPS=""
CPAN=""
...
# Other dependencies
dotfilesreq git sxhkd volumeicon nitrogen misc
dotfilesreqadmin
